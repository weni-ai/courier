...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Interactive Button Message Send",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"button","body":{"text":"Interactive Button Msg"},"footer":{},"action":{"buttons":[{"type":"reply","reply":{"id":"0","title":"BUTTON1"}}]}}}`,
		SendPrep:    setSendURL},
	{Label: "Interactive Button Message Send with Slashes",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"button","body":{"text":"Interactive Button Msg"},"footer":{},"action":{"buttons":[{"type":"reply","reply":{"id":"0","title":"\\BUTTON1"}},{"type":"reply","reply":{"id":"1","title":"/BUTTON2"}}]}}}`,
		SendPrep:    setSendURL},
	...
	{Label: "Catalog Message Send 1 product",
		Metadata: json.RawMessage(`{"body":"Catalog Body Msg", "products": {"product1":["p90duct-23t41l32-1D"]}, "action": "View Products", "send_catalog":false}`),
	...
	{Label: "Catalog Message Send 2 products",
		Metadata: json.RawMessage(`{"body":"Catalog Body Msg", "products": {"product1":["p1"],"product2":["p2"]}, "action": "View Products", "send_catalog":false}`),
		Text:     "Catalog Msg", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"product_list","body":{"text":"Catalog Body Msg"},"action":{"sections":[{"title":"product1","product_items":[{"product_retailer_id":"p1"}]},{"title":"product2","product_items":[{"product_retailer_id":"p2"}]}],"catalog_id":"c4t4l0g-1D","name":"View Products"}}}`,
		SendPrep:    setSendURL},
	{Label: "Catalog Message Send 30+ products",
		Metadata: json.RawMessage(`{"body":"Catalog Body Msg", "products": {"product1":["p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10", "p11", "p12", "p13", "p14", "p15", "p16", "p17", "p18", "p19", "p20", "p21", "p22", "p23", "p24", "p25", "p26", "p27", "p28", "p29", "p30", "p31"]}, "action": "View Products", "send_catalog":false}`),
		Text:     "Catalog Msg", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"product_list","body":{"text":"Catalog Body Msg"},"action":{"sections":[{"title":"product1","product_items":[{"product_retailer_id":"p1"},{"product_retailer_id":"p2"},{"product_retailer_id":"p3"},{"product_retailer_id":"p4"},{"product_retailer_id":"p5"},{"product_retailer_id":"p6"},{"product_retailer_id":"p7"},{"product_retailer_id":"p8"},{"product_retailer_id":"p9"},{"product_retailer_id":"p10"},{"product_retailer_id":"p11"},{"product_retailer_id":"p12"},{"product_retailer_id":"p13"},{"product_retailer_id":"p14"},{"product_retailer_id":"p15"},{"product_retailer_id":"p16"},{"product_retailer_id":"p17"},{"product_retailer_id":"p18"},{"product_retailer_id":"p19"},{"product_retailer_id":"p20"},{"product_retailer_id":"p21"},{"product_retailer_id":"p22"},{"product_retailer_id":"p23"},{"product_retailer_id":"p24"},{"product_retailer_id":"p25"},{"product_retailer_id":"p26"},{"product_retailer_id":"p27"},{"product_retailer_id":"p28"},{"product_retailer_id":"p29"},{"product_retailer_id":"p30"}]},{"title":"product1","product_items":[{"product_retailer_id":"p31"}]}],"catalog_id":"c4t4l0g-1D","name":"View Products"}}}`,
		SendPrep:    setSendURL},
