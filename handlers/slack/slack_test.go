...
var handleTestCases = []ChannelHandleTestCase{
	...
	},
	{
		...
		Headers:    map[string]string{},
		Data:       imageFileMsg,
		Attachment: Sp("https://files.slack.com/files-pri/T03CN5KTA6S-F03GTH43SSF/download/batata.jpg"),
		URN:        Sp("slack:C0123ABCDEF"),
		Text:       Sp(""),
		Status:     200,
		Response:   "Accepted",
	...
	},
	{
		...
		Headers:    map[string]string{},
		Data:       audioFileMsg,
		Attachment: Sp("https://files.slack.com/files-pri/T03CN5KTA6S-F03GWURCZL4/download/here_we_go_again.mp3"),
		URN:        Sp("slack:C0123ABCDEF"),
		Text:       Sp(""),
		Status:     200,
		Response:   "Accepted",
