...
var defaultSendTestCases = []ChannelSendTestCase{
	...
	{Label: "Named Template Send Rejected",
		Text:     "templated message",
		URN:      "whatsapp:250788123123",
		Error:    `named templates are not supported on channel: 8eb23e93-5ecb-45ba-b726-3b064e0c56ab`,
		Metadata: json.RawMessage(`{ "templating": { "template": { "name": "cobranca_bf4", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "parameter_format": "named", "named_variables": {"nome": "João"}}}`),
	},
