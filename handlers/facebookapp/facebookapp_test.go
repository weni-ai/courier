...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Carousel Template Send - Unknown attachment type",
		...
		Metadata:    json.RawMessage(`{ "templating": { "template": { "name": "carousel_promo", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "is_carousel": true, "carousel_cards": [{"body": "Test"}]}}`),
	...
	{Label: "Carousel Template Send - Document Cards (unsupported)",
		...
		Attachments: []string{"application/pdf:https://foo.bar/card1.pdf"},
	...
	{Label: "Carousel Template Send - Only Quick Reply Buttons",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "qr_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "is_carousel": true, "carousel_cards": [{"buttons": [{"sub_type": "quick_reply", "index": 0, "parameter": "qr1"}, {"sub_type": "quick_reply", "index": 1, "parameter": "qr2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
	...
	{Label: "Carousel Template Send - Only Media (No Body/Buttons)",
		...
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Only Body/Buttons (No Media)",
		Text: "Carousel without media", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "text_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "is_carousel": true, "carousel_cards": [{"body": "Card 1 Text", "buttons": [{"sub_type": "quick_reply", "index": 0, "parameter": "qr1"}]}, {"body": "Card 2 Text", "buttons": [{"sub_type": "quick_reply", "index": 0, "parameter": "qr2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"text_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"body","parameters":[{"type":"text","text":"Card 1 Text"}]},{"type":"button","sub_type":"quick_reply","index":0,"parameters":[{"type":"payload","payload":"qr1"}]}]},{"card_index":1,"components":[{"type":"body","parameters":[{"type":"text","text":"Card 2 Text"}]},{"type":"button","sub_type":"quick_reply","index":0,"parameters":[{"type":"payload","payload":"qr2"}]}]}]}]}}`,
		SendPrep:    setSendURL},
