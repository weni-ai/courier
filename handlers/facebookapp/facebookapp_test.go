...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Carousel Template Send",
		...
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "carousel_promo", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "variables": ["Welcome", "Summer Sale"], "carousel_cards": [{"body": ["Card 1 Text", "Promo 1"], "buttons": [{"sub_type": "quick_reply", "parameter": "card1_qr"}, {"sub_type": "url", "text": "Shop Now", "parameter": "promo1"}]}, {"body": ["Card 2 Text", "Promo 2"], "buttons": [{"sub_type": "quick_reply", "parameter": "card2_qr"}, {"sub_type": "url", "text": "Buy Now", "parameter": "promo2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"carousel_promo","language":{"policy":"deterministic","code":"en"},"components":[{"type":"body","parameters":[{"type":"text","text":"Welcome"},{"type":"text","text":"Summer Sale"}]},{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"body","parameters":[{"type":"text","text":"Card 1 Text"},{"type":"text","text":"Promo 1"}]},{"type":"button","sub_type":"quick_reply","index":0,"parameters":[{"type":"payload","payload":"card1_qr"}]},{"type":"button","sub_type":"url","index":1,"parameters":[{"type":"url","text":"Shop Now","url":"promo1"}]}]},{"card_index":1,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card2.jpg"}}]},{"type":"body","parameters":[{"type":"text","text":"Card 2 Text"},{"type":"text","text":"Promo 2"}]},{"type":"button","sub_type":"quick_reply","index":0,"parameters":[{"type":"payload","payload":"card2_qr"}]},{"type":"button","sub_type":"url","index":1,"parameters":[{"type":"url","text":"Buy Now","url":"promo2"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Video Cards",
		...
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "video_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Video 1 Desc"], "buttons": [{"sub_type": "quick_reply", "parameter": "video1_qr"}]}, {"body": ["Video 2 Desc"], "buttons": [{"sub_type": "quick_reply", "parameter": "video2_qr"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
	...
	{Label: "Carousel Template Send - Without Body Variables",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg", "image/jpeg:https://foo.bar/card2.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "simple_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"buttons": [{"sub_type": "url", "text": "Link 1", "parameter": "link1"}]}, {"buttons": [{"sub_type": "url", "text": "Link 2", "parameter": "link2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"simple_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"url","text":"Link 1","url":"link1"}]}]},{"card_index":1,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card2.jpg"}}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"url","text":"Link 2","url":"link2"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Without Buttons",
		...
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "info_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Product info", "Price: $99"]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"info_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"body","parameters":[{"type":"text","text":"Product info"},{"type":"text","text":"Price: $99"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	...
	{Label: "Carousel Template Send - Unknown attachment type",
		...
		Attachments: []string{"unknown/unknown:https://foo.bar/unknown.file"},
		Metadata:    json.RawMessage(`{ "templating": { "template": { "name": "carousel_promo", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Test"]}]}}`),
		Error:       "unknown attachment mime type for carousel card: unknown",
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Document Cards",
		...
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "doc_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Doc 1 Info"], "buttons": [{"sub_type": "url", "text": "View Doc", "parameter": "doc1_link"}]}, {"body": ["Doc 2 Info"], "buttons": [{"sub_type": "url", "text": "View Doc", "parameter": "doc2_link"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"doc_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"document","document":{"link":"https://foo.bar/card1.pdf","filename":"card1.pdf"}}]},{"type":"body","parameters":[{"type":"text","text":"Doc 1 Info"}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"url","text":"View Doc","url":"doc1_link"}]}]},{"card_index":1,"components":[{"type":"header","parameters":[{"type":"document","document":{"link":"https://foo.bar/card2.pdf","filename":"card2.pdf"}}]},{"type":"body","parameters":[{"type":"text","text":"Doc 2 Info"}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"url","text":"View Doc","url":"doc2_link"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Only URL Buttons",
		Text: "Carousel with only url buttons", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "url_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"buttons": [{"sub_type": "url", "text": "URL 1", "parameter": "url1"}, {"sub_type": "url", "text": "URL 2", "parameter": "url2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"url_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"url","text":"URL 1","url":"url1"}]},{"type":"button","sub_type":"url","index":1,"parameters":[{"type":"url","text":"URL 2","url":"url2"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Only Quick Reply Buttons",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "qr_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"buttons": [{"sub_type": "quick_reply", "parameter": "qr1"}, {"sub_type": "quick_reply", "parameter": "qr2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		...
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Phone Number Button",
		Text: "Carousel with phone number button", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "phone_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Contact us"], "buttons": [{"sub_type": "phone_number", "text": "Call Us", "parameter": "+15550051310"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"phone_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"body","parameters":[{"type":"text","text":"Contact us"}]},{"type":"button","sub_type":"phone_number","index":0,"parameters":[{"type":"phone_number","text":"Call Us","phone_number":"+15550051310"}]}]}]}]}}`,
		SendPrep:    setSendURL},
