...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Send Flow Message",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"flow","header":{"type":"text","text":"header text","video":{},"image":{},"document":{}},"body":{"text":"msg text"},"footer":{"text":"footer text"},"action":{"name":"flow","parameters":{"flow_action":"navigate","flow_action_payload":{"data":{"list":[1,2],"name":"John Doe"},"screen":"WELCOME_SCREEN"},"flow_cta":"Start Flow","flow_id":"29287124123","flow_message_version":"3","flow_token":"547deaf7-7620-4434-95b3-58675999c4b7","mode":"published"}}}}`,
		SendPrep:    setSendURL},
	{Label: "Send Order Details Message",
		Metadata: json.RawMessage(`{"order_details_message":{"reference_id":"220788123125","type":"digital-goods","payment_link":"https://foo.bar","total_amount":18200,"order":{"catalog_id":"14578923723","expiration":{"timestamp":"1727794172","description":"expiration description"},"items":[{"retailer_id":"789236789","name":"item 1","amount":200,"quantity":2,"sale_amount":100},{"retailer_id":"59016733","name":"item 2","amount":4000,"quantity":9,"sale_amount":2000}],"subtotal":36400,"tax":500,"shipping":{"value":900,"description":"shipping description"},"discount":{"value":1000,"description":"discount description","program_name":"discount program name"}}},"footer":"footer text","header_text":"header text","header_type":"text","interaction_type":"order_details","text":"msgs text"}`),
		Text:     "msg text", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"interactive","interactive":{"type":"order_details","header":{"type":"text","text":"header text","video":{},"image":{},"document":{}},"body":{"text":"msg text"},"footer":{"text":"footer text"},"action":{"name":"review_and_pay","parameters":{"currency":"BRL","order":{"catalog_id":"14578923723","discount":{"description":"discount description","offset":100,"program_name":"discount program name","value":1000},"expiration":{"description":"expiration description","timestamp":"1727794172"},"items":[{"retailer_id":"789236789","name":"item 1","amount":200,"quantity":2,"sale_amount":100},{"retailer_id":"59016733","name":"item 2","amount":4000,"quantity":9,"sale_amount":2000}],"shipping":{"description":"shipping description","offset":100,"value":900},"status":"pending","subtotal":{"offset":100,"value":36400},"tax":{"offset":100,"value":500}},"payment_settings":{"payment_link":{"uri":"https://foo.bar"},"type":"payment_link"},"payment_type":"br","reference_id":"220788123125","total_amount":{"offset":100,"value":18200},"type":"digital-goods"}}}}`,
		SendPrep:    setSendURL},
}
