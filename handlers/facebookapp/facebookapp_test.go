...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Catalog Message Send 30+ products",
		Metadata: json.RawMessage(`{"body":"Catalog Body Msg", "products": {"product1":["p1", "p2", "p3", "p4", "p5"],"product2":["p6", "p7", "p8", "p9", "p10"],"product3":["p11", "p12", "p13", "p14", "p15"],"product4":["p16", "p17", "p18", "p19", "p20"],"product5":["p21", "p22", "p23", "p24", "p25"],"product6":["p26", "p27", "p28", "p29", "p30"],"product7":["p31"]}, "action": "View Products", "send_catalog":false}`),
		Text:     "Catalog Msg", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
