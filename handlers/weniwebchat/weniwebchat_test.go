...
var productSendTestCases = []ChannelSendTestCase{
	...
	},
	{
		...
		ResponseStatus: 200,
		SendPrep:       prepareSendMsg,
		Metadata:       json.RawMessage(`{"products":[{"product":"Products","product_retailer_info":[{"retailer_id":"p-1","name":"Item","price":"10.00","currency":"BRL","image":"https://example.com/item.jpg","description":"An item","seller_id":"seller"}]}],"action":"View","carousel":false}`),
	},
}
