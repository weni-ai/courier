...
var defaultSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		...
		RequestBody: `{"to":"250788123123","type":"text","preview_url":true,"text":{"body":"Simple Message"}}`,
		SendPrep:    setSendURL},
	{Label: "Unicode Send",
		Text: "☺", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"to":"250788123123","type":"text","preview_url":true,"text":{"body":"☺"}}`,
		SendPrep:    setSendURL},
	{Label: "Error",
		Text: "Error", URN: "whatsapp:250788123123",
		Status:       "E",
		ResponseBody: `{ "errors": [{ "title": "Error Sending" }] }`, ResponseStatus: 403,
		RequestBody: `{"to":"250788123123","type":"text","preview_url":true,"text":{"body":"Error"}}`,
		SendPrep:    setSendURL},
	{Label: "No Message ID",
		Text: "Error", URN: "whatsapp:250788123123",
		Status:       "E",
	...
	{Label: "WhatsApp Contact Error",
		...
		Responses: map[MockedRequest]MockedResponse{
			MockedRequest{
				Method: "POST",
				Path:   "/v1/messages",
				Body:   `{"to":"250788123123","type":"text","preview_url":true,"text":{"body":"contact status error"}}`,
			}: MockedResponse{
				Status: 404,
	...
	{Label: "Try Messaging Again After WhatsApp Contact Check",
		...
		Responses: map[MockedRequest]MockedResponse{
			MockedRequest{
				Method: "POST",
				Path:   "/v1/messages",
				Body:   `{"to":"250788123123","type":"text","preview_url":true,"text":{"body":"try again"}}`,
			}: MockedResponse{
				Status: 404,
				Body:   `{"errors": [{"code": 1006, "title": "Resource not found", "details": "unknown contact"}]}`,
			},
	...
	{Label: "Try Messaging Again After WhatsApp Contact Check With Returned WhatsApp ID",
		...
		Responses: map[MockedRequest]MockedResponse{
			MockedRequest{
				Method: "POST",
				Path:   "/v1/messages",
				Body:   `{"to":"5582999887766","type":"text","preview_url":true,"text":{"body":"try again"}}`,
			}: MockedResponse{
				Status: 404,
				Body:   `{"errors": [{"code": 1006, "title": "Resource not found", "details": "unknown contact"}]}`,
			},
			...
			MockedRequest{
				...
				Path:     "/v1/messages",
				RawQuery: "retry=1",
				Body:     `{"to":"558299887766","type":"text","preview_url":true,"text":{"body":"try again"}}`,
			}: MockedResponse{
				Status: 201,
				Body:   `{"messages": [{"id": "157b5e14568e8"}]}`,
			},
