...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	{Label: "Carousel Template Send - Without Body Variables",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg", "image/jpeg:https://foo.bar/card2.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "simple_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"buttons": [{"sub_type": "url", "parameter": "link1"}]}, {"buttons": [{"sub_type": "url", "parameter": "link2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
	...
	{Label: "Carousel Template Send - Document Cards",
		...
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "doc_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Doc 1 Info"], "buttons": [{"sub_type": "url", "parameter": "doc1_link"}]}, {"body": ["Doc 2 Info"], "buttons": [{"sub_type": "url", "parameter": "doc2_link"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"doc_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"document","document":{"link":"https://foo.bar/card1.pdf","filename":"card1.pdf"}}]},{"type":"body","parameters":[{"type":"text","text":"Doc 1 Info"}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"text","text":"doc1_link"}]}]},{"card_index":1,"components":[{"type":"header","parameters":[{"type":"document","document":{"link":"https://foo.bar/card2.pdf","filename":"card2.pdf"}}]},{"type":"body","parameters":[{"type":"text","text":"Doc 2 Info"}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"text","text":"doc2_link"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	{Label: "Carousel Template Send - Only URL Buttons",
		Text: "Carousel with only url buttons", URN: "whatsapp:250788123123",
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "url_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"buttons": [{"sub_type": "url", "parameter": "url1"}, {"sub_type": "url", "parameter": "url2"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"url_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"button","sub_type":"url","index":0,"parameters":[{"type":"text","text":"url1"}]},{"type":"button","sub_type":"url","index":1,"parameters":[{"type":"text","text":"url2"}]}]}]}]}}`,
		SendPrep:    setSendURL},
	...
	{Label: "Carousel Template Send - Phone Number Button",
		...
		Status: "W", ExternalID: "157b5e14568e8",
		Attachments:  []string{"image/jpeg:https://foo.bar/card1.jpg"},
		Metadata:     json.RawMessage(`{ "templating": { "template": { "name": "phone_carousel", "uuid": "171f8a4d-f725-46d7-85a6-11aceff0bfe3" }, "language": "eng", "carousel_cards": [{"body": ["Contact us"], "buttons": [{"sub_type": "phone_number", "parameter": "+15550051310"}]}]}}`),
		ResponseBody: `{ "messages": [{"id": "157b5e14568e8"}] }`, ResponseStatus: 201,
		RequestBody: `{"messaging_product":"whatsapp","recipient_type":"individual","to":"250788123123","type":"template","template":{"name":"phone_carousel","language":{"policy":"deterministic","code":"en"},"components":[{"type":"carousel","cards":[{"card_index":0,"components":[{"type":"header","parameters":[{"type":"image","image":{"link":"https://foo.bar/card1.jpg"}}]},{"type":"body","parameters":[{"type":"text","text":"Contact us"}]},{"type":"button","sub_type":"phone_number","index":0,"parameters":[{"type":"text","text":"+15550051310"}]}]}]}]}}`,
		SendPrep:    setSendURL},
